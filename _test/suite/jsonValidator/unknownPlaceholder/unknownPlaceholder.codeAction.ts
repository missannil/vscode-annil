...
const DELETE_ACTION_TITLE = `移除未知占位组件 “${UNKNOWN_PLACEHOLDER}”`;

/** 请求并应用“未知占位组件”规则的真实 Quick Fix。 */
export async function applyUnknownPlaceholderQuickFix(uri: Uri, diagnostic: Diagnostic): Promise<void> {

...
describe("missingAttrTernary", () => {
  test("缺少 Ternary 属性支持 Quick Fix 和 fix-all", async () => {
    const uri = Uri.file(
      path.join(
        projectRoot,
        "_test/suite/wxmlValidator/element/customComponent/missingAttr/missingAttrTernary/missingAttrTernary.wxml",
      ),
    );
